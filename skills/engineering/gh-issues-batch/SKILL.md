...
Pro Issue ein eigener Branch: `issue/<nummer>-<kebab-case-titel>`. Vom aktuellen `main`/`master` aus erstellen. Bei parallelen Issues: jedes Subagent arbeitet auf seinem eigenen Branch in einem eigenen Worktree:
